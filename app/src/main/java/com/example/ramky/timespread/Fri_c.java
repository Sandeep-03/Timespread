...
public class Fri_c extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.fri_c, container, false);
        recyclerView = (RecyclerView)v.findViewById(R.id.recycler_Class);
       ...
       /* recyclerView.setAdapter(adapter);*/
        ...
        Login l = new Login();
        int i;
        ArrayList<Course> c1 = Login.fri;

        busses = new ArrayList<>();

        for(i=0;i<c1.size();i++) {

            busses.add(new timetable_c(c1.get(i).getName(),c1.get(i).getProfessor(),"",l.convertTime(c1.get(i).getWeekdays().get(4))));
        }
