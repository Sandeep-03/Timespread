...
public class Thu_c extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.thu_c, container, false);
       ...
       /* recyclerView.setAdapter(adapter);*/
        ...
        ArrayList<Course> c1 = Login.thu;

        busses = new ArrayList<>();

        for(i=0;i<c1.size();i++) {

            busses.add(new timetable_c(c1.get(i).getName(),c1.get(i).getProfessor(),"",l.convertTime(c1.get(i).getWeekdays().get(3))));
        }
