...
public class Tue_c extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.tue_c, container, false);
       ...
       /* recyclerView.setAdapter(adapter);*/
        ...
        Login l = new Login();
        int i;
        ArrayList<Course> c1 = Login.tue;

        busses = new ArrayList<>();

        for(i=0;i<c1.size();i++) {

            busses.add(new timetable_c(c1.get(i).getName(),c1.get(i).getProfessor(),"",l.convertTime(c1.get(i).getWeekdays().get(1))));
        }
