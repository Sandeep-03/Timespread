...
public class Wed_c extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.wed_c, container, false);
       ...
       /* recyclerView.setAdapter(adapter);*/
        ...
        Login l = new Login();
        int i;
        ArrayList<Course> c1 = Login.wed;

        busses = new ArrayList<>();

        for(i=0;i<c1.size();i++) {

            busses.add(new timetable_c(c1.get(i).getName(),c1.get(i).getProfessor(),"",l.convertTime(c1.get(i).getWeekdays().get(2))));
        }
